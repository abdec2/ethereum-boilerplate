    ...
    return (
        <div className={`w-80 p-4 bg-gray-800 rounded-lg ${animationClass}`}>
            <div className="space-y-2">
                <h3 className=" text-white text-xl font-medium leading-7 truncate">{plan}</h3>
            ...
            <div>
                <button className="btn-grad text-white focus:outline-none w-full px-6 py-2 text-xl rounded-full">MINT</button>
            </div>
        </div>
    )
}
